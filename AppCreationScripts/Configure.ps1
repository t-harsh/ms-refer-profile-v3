...
Function ConfigureApplications {
    ...
    Write-Host "Creating the AAD application (ms-refer-form-spa)"
    # create the application 
    $spaAadApplication = New-MgApplication -DisplayName "ms-refer-form-spa" `
    ...
    Write-Host "Done creating the spa application (ms-refer-form-spa)"
    ...
    Add-Content -Value "<tr><td>spa</td><td>$currentAppId</td><td><a href='$spaPortalUrl'>ms-refer-form-spa</a></td></tr>" -Path createdApps.html
